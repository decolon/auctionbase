...
create table UserLogin(UserID varchar primary key REFERENCES User(UserID), Password varchar);
insert into UserLogin values("thov", "password");
insert into UserLogin values("zulu28", "password");
